    ...
    extends DefaultBufferedBlockCipher
{
     ...
     * @exception com.android.internal.org.bouncycastle.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception com.android.internal.org.bouncycastle.crypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception com.android.internal.org.bouncycastle.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
