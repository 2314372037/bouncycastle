package com.android.internal.org.bouncycastle.jcajce.provider.asymmetric.dstu;
...
import com.android.internal.org.bouncycastle.asn1.ua.DSTU4145BinaryField;
import com.android.internal.org.bouncycastle.asn1.ua.DSTU4145ECBinary;
import com.android.internal.org.bouncycastle.asn1.ua.DSTU4145NamedCurves;
import com.android.internal.org.bouncycastle.asn1.ua.DSTU4145Params;
import com.android.internal.org.bouncycastle.asn1.ua.DSTU4145PointEncoder;
import com.android.internal.org.bouncycastle.asn1.ua.UAObjectIdentifiers;
    ...
    implements ECPublicKey, com.android.internal.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        com.android.internal.org.bouncycastle.jce.spec.ECParameterSpec spec = null;
        X9ECParameters x9Params = null;

        if (seq.getObjectAt(0) instanceof ASN1Integer)
        {
            x9Params = X9ECParameters.getInstance(seq);
            spec = new  com.android.internal.org.bouncycastle.jce.spec.ECParameterSpec(x9Params.getCurve(), x9Params.getG(), x9Params.getN(), x9Params.getH(), x9Params.getSeed());
        }
        else
        {
            ...
            else
            {
                ...
                spec = new com.android.internal.org.bouncycastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
            }
        }
