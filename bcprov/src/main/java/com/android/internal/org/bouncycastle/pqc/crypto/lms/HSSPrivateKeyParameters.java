...
import static com.android.internal.org.bouncycastle.pqc.crypto.lms.HSS.rangeTestKeys;
    ...
    implements LMSContextBasedSigner
{
    ...
    void resetKeyToIndex()
    {
        ...
        for (int i = 1; i < qTreePath.length; i++)
        {
            ...
            //
            boolean seedEquals = com.android.internal.org.bouncycastle.util.Arrays.areEqual(childI, keys[i].getI())
                && com.android.internal.org.bouncycastle.util.Arrays.areEqual(childSeed, keys[i].getMasterSecret());
