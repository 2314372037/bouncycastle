...
import com.android.internal.org.bouncycastle.asn1.x500.style.BCStrictStyle;
import com.android.internal.org.bouncycastle.asn1.x509.AccessDescription;
import com.android.internal.org.bouncycastle.asn1.x509.AlgorithmIdentifier;
import com.android.internal.org.bouncycastle.asn1.x509.AuthorityInformationAccess;
...
import com.android.internal.org.bouncycastle.internal.asn1.bsi.BSIObjectIdentifiers;
import com.android.internal.org.bouncycastle.internal.asn1.eac.EACObjectIdentifiers;
    ...
    implements PKIXCertRevocationChecker
{
        ...
        throws CertPathValidatorException
    {
        ...
        if (ocspResponses.get(cert) == null && ocspUri != null)
        {
            ...
            com.android.internal.org.bouncycastle.asn1.x509.Certificate issuer = extractCert();
    ...
    {
        byte[] extValue = cert.getExtensionValue(com.android.internal.org.bouncycastle.asn1.x509.Extension.authorityInfoAccess.getId());
        if (extValue == null)
        {
            return null;
        }
        ...
        try
        {
            ...
            if (sig.verify(basicResp.getSignature().getOctets()))
            {
                if (nonce != null)
                {
                    ...
                    com.android.internal.org.bouncycastle.asn1.x509.Extension ext = exts.getExtension(OCSPObjectIdentifiers.id_pkix_ocsp_nonce);
    ...
    private com.android.internal.org.bouncycastle.asn1.x509.Certificate extractCert()
        throws CertPathValidatorException
    {
        try
        {
            return com.android.internal.org.bouncycastle.asn1.x509.Certificate.getInstance(parameters.getSigningCert().getEncoded());
        }
        catch (Exception e)
        {
    ...
    private CertID createCertID(CertID base, com.android.internal.org.bouncycastle.asn1.x509.Certificate issuer, ASN1Integer serialNumber)
        throws CertPathValidatorException
    {
        return createCertID(base.getHashAlgorithm(), issuer, serialNumber);
    }

    private CertID createCertID(AlgorithmIdentifier digestAlg, com.android.internal.org.bouncycastle.asn1.x509.Certificate issuer, ASN1Integer serialNumber)
        throws CertPathValidatorException
    {
        try
        {
