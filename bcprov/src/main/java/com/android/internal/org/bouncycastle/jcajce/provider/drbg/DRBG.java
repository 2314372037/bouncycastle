...
import com.android.internal.org.bouncycastle.crypto.prng.EntropySource;
import com.android.internal.org.bouncycastle.crypto.prng.EntropySourceProvider;
import com.android.internal.org.bouncycastle.crypto.prng.SP800SecureRandom;
import com.android.internal.org.bouncycastle.crypto.prng.SP800SecureRandomBuilder;
 ...
 * <p>
 * com.android.internal.org.bouncycastle.drbg.gather_pause_secs - is to stop the entropy collection thread from grabbing all
 ...
 * </p>
 * <p>
 * com.android.internal.org.bouncycastle.drbg.entropysource - is the class name for an implementation of EntropySourceProvider.
 * For example, one could be provided which just reads directly from /dev/random and the extra infrastructure used here
 * could be avoided.
 * </p>
 * <p>
 * com.android.internal.org.bouncycastle.drbg.entropy_thread - if true the provider will start a single daemon thread for handling entropy requests,
