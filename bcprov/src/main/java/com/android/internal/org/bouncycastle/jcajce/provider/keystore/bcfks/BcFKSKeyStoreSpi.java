package com.android.internal.org.bouncycastle.jcajce.provider.keystore.bcfks;
...
import com.android.internal.org.bouncycastle.asn1.bc.EncryptedObjectStoreData;
import com.android.internal.org.bouncycastle.asn1.bc.EncryptedPrivateKeyData;
import com.android.internal.org.bouncycastle.asn1.bc.EncryptedSecretKeyData;
import com.android.internal.org.bouncycastle.asn1.bc.ObjectData;
import com.android.internal.org.bouncycastle.asn1.bc.ObjectDataSequence;
import com.android.internal.org.bouncycastle.asn1.bc.ObjectStore;
import com.android.internal.org.bouncycastle.asn1.bc.ObjectStoreData;
import com.android.internal.org.bouncycastle.asn1.bc.ObjectStoreIntegrityCheck;
import com.android.internal.org.bouncycastle.asn1.bc.PbkdMacIntegrityCheck;
import com.android.internal.org.bouncycastle.asn1.bc.SecretKeyData;
import com.android.internal.org.bouncycastle.asn1.bc.SignatureCheck;
...
import com.android.internal.org.bouncycastle.crypto.digests.SHA3Digest;
...
import com.android.internal.org.bouncycastle.crypto.util.PBKDF2Config;
import com.android.internal.org.bouncycastle.crypto.util.PBKDFConfig;
import com.android.internal.org.bouncycastle.crypto.util.ScryptConfig;
import com.android.internal.org.bouncycastle.internal.asn1.cms.CCMParameters;
...
import com.android.internal.org.bouncycastle.internal.asn1.misc.ScryptParams;
import com.android.internal.org.bouncycastle.internal.asn1.nsri.NSRIObjectIdentifiers;
...
import com.android.internal.org.bouncycastle.jcajce.BCFKSLoadStoreParameter;
import com.android.internal.org.bouncycastle.jcajce.BCFKSStoreParameter;
...
import com.android.internal.org.bouncycastle.jce.interfaces.ECKey;
    ...
    extends KeyStoreSpi
{
    ...
    public Certificate[] engineGetCertificateChain(String alias)
    {
        ...
        if (ent != null)
        {
            ...
            {
                EncryptedPrivateKeyData encPrivData = EncryptedPrivateKeyData.getInstance(ent.getData());
                com.android.internal.org.bouncycastle.asn1.x509.Certificate[] certificates = encPrivData.getCertificateChain();
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (helper != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(com.android.internal.org.bouncycastle.asn1.x509.Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
    ...
    {
        com.android.internal.org.bouncycastle.asn1.x509.Certificate[] certChain = new com.android.internal.org.bouncycastle.asn1.x509.Certificate[chain.length];
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = com.android.internal.org.bouncycastle.asn1.x509.Certificate.getInstance(chain[i].getEncoded());
        }
        ...
        else if (parameter instanceof BCFKSLoadStoreParameter)
        {
            ...
            if (bcParam.getStoreSignatureKey() != null)
            {
                ...
                try
                {
                    ...
                    if (certs != null)
                    {
                        com.android.internal.org.bouncycastle.asn1.x509.Certificate[] certificates = new com.android.internal.org.bouncycastle.asn1.x509.Certificate[certs.length];
                        for (int i = 0; i != certificates.length; i++)
                        {
                            certificates[i] = com.android.internal.org.bouncycastle.asn1.x509.Certificate.getInstance(certs[i].getEncoded());
                        }
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        ...
        else if (integrityCheck.getType() == ObjectStoreIntegrityCheck.SIG_CHECK)
        {
            ...
            try
            {
                com.android.internal.org.bouncycastle.asn1.x509.Certificate[] certificates = sigCheck.getCertificates();
                if (validator != null)
                {
